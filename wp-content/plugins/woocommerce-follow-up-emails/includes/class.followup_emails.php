...
class FollowUpEmails {
    ...
    public static $db_version           = '5.0.8';
    ...
    public static function update_db( $force = false ) {
        ...
        if ( version_compare($installed_db_version, '4.20', '<=') ) {
...
KEY category_id (category_id)
        ...
        if ( self::$db_version == '1.1' ) {
            ...
            foreach ( $emails as $email ) {
                ...
                $wpdb->update( $wpdb->prefix .'followup_emails', array('send_date_hour' => $hour, 'meta' => serialize($meta) ) );
            }
        }
    ...
    static function update_settings() {
        ...
        // bcc
        if ( isset($_POST['bcc']) ) update_option('fue_bcc', $_POST['bcc']);
